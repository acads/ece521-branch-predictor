...
#
# gnuplot script to plot 'm' size vs. 'miss-predictions' for jpeg_trace.txt. 
#
...
plot 'jpeg_bimodal.dat' using 1:2 with linespoints ls 1 title 'misprediction rate for jpeg'
