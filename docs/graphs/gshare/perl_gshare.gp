...
#
# gnuplot script to plot misprediction rate for trace perl for different m and
# n values.
#
...
plot 'perl_gshare.dat' using 1:2 index 0 title 'n = 2' with linespoints ls 1,    \
